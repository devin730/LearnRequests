...
class DoubanFilesTop250():
    def __init__(self):
        ...
        self.worksheet.write(0, 3, label='点评人数')
        self.worksheet.write(0, 4, label='简介')
        self.worksheet.write(0, 5, label='网址')
        self.film_count = 1
    ...
    def crawl(self, url):
        ...
        for list in li_lists:
            ...
            self.worksheet.write(self.film_count, 3, label=comments_count)
            self.worksheet.write(self.film_count, 4, label=quote)
            self.worksheet.write(self.film_count, 5, label=film_url)
